...
The mindset for working with LLM agents. Collaborator not oracle; you're the pilot; agents sound authoritative even when they're wrong; non-determinism is both a feature and a weakness; the difference between a "smart agent" and a "dumb agent" session.
...
How agents work on what's in front of them. Context windows and their limits, shaping context deliberately, auto-memory as a double-edged tool, recognizing when memory has gone stale.
